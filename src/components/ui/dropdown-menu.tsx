...
// Apply buttonVariants to the Trigger by wrapping the primitive and forwarding props
...
// SubTrigger should look like a menu button
...
// Each item should look like a button, so apply buttonVariants
